...
f.generate('/tmp/caissebuild/typeface-zh-AaKaiSong2WanZi2_remapped.ttf', flags=('no-FFTM-table'))
f.close()

# To temporarily use the remapped font:
# cp /tmp/caissebuild/typeface-zh-AaKaiSong2WanZi2_remapped.ttf ../../build/bin/AaKaiSong2WanZi2_remapped.ttf
# In the target page HTML:
# src: url(/bin/AaKaiSong2WanZi2_remapped.ttf);

# To build full WOFF2:
# woff2_compress /tmp/caissebuild/typeface-zh-AaKaiSong2WanZi2_remapped.ttf && mv /tmp/caissebuild/typeface-zh-AaKaiSong2WanZi2_remapped.woff2 ../../content/fonts-zh/AaKaiSong2-full.woff2
