// deno run --allow-read=/tmp/caissebuild/katex-list.txt --allow-write=rendered.txt process.js
...
const rendered = []
for (const line of (await Deno.readTextFile('/tmp/caissebuild/katex-list.txt')).split('\n')) {
